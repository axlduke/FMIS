...
var Ut = function(t3) {
  var r2 = t3.icon, n = t3.className, o = "react-datepicker__calendar-icon";
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s3) {
      ...
      t4 = import_react2.default.createElement(Popper, ve({ modifiers: p, placement: c2 }, l), function(t5) {
        ...
        return import_react2.default.createElement(Jt, { enableTabLoop: u2 }, import_react2.default.createElement("div", { ref: r2, style: n3, className: y3, "data-placement": o3, onKeyDown: h3 }, import_react2.default.cloneElement(i2, { arrowProps: a4 })));
      });
    }
    this.props.popperContainer && (t4 = import_react2.default.createElement(this.props.popperContainer, {}, t4)), m3 && !s3 && (t4 = import_react2.default.createElement($t, { portalId: m3, portalHost: f }, t4));
...
var rr = function(t3) {
  ...
  function s3(t4) {
    ...
    return he(this, s3), ye(ke(i2 = a3.call(this, t4)), "getPreSelection", function() {
      ...
      i2.setState({ open: e3, preSelection: e3 && i2.state.open ? i2.state.preSelection : i2.calcInitialState().preSelection, lastPreSelectChange: or }, function() {
      ...
      if (!i2.props.onChangeRaw || (i2.props.onChangeRaw.apply(ke(i2), t5), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        i2.setState({ inputValue: n.target.value, lastPreSelectChange: nr });
      ...
      if (i2.state.open || i2.props.inline || i2.props.preventOpenOnFocus) {
        if (i2.state.open) {
          ...
          "Enter" === t5 ? (e3.preventDefault(), i2.inputOk() && i2.state.lastPreSelectChange === or ? (i2.handleSelect(n, e3), !i2.props.shouldCloseOnSelect && i2.setPreSelection(n)) : i2.setOpen(false)) : "Escape" === t5 ? (e3.preventDefault(), i2.sendFocusBackToInput(), i2.setOpen(false)) : "Tab" === t5 && i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: tr });
        }
      } else
      ...
      if ("Enter" === t5)
        ...
        e3.preventDefault(), i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: tr });
        ...
        if (!n)
          return void (i2.props.onInputError && i2.props.onInputError({ code: 1, msg: tr }));
        if (e3.preventDefault(), i2.setState({ lastPreSelectChange: or }), i2.props.adjustDateOnChange && i2.setSelected(n), i2.setPreSelection(n), i2.props.inline) {
      ...
      var t5, n = (0, import_classnames.default)(i2.props.className, ye({}, Zt, i2.state.open)), o = i2.props.customInput || import_react2.default.createElement("input", { type: "text" }), a4 = i2.props.customInputRef || "ref", s4 = "string" == typeof i2.props.value ? i2.props.value : "string" == typeof i2.state.inputValue ? i2.state.inputValue : i2.props.selectsRange ? function(e3, t6, r2) {
        if (!e3)
          return "";
  ...
  return fe(s3, [{ key: "componentDidMount", value: function() {
    ...
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react2.default.createElement(Jt, { enableTabLoop: this.props.enableTabLoop }, import_react2.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t4)) : null;
